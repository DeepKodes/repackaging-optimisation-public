...
class BoxDimensionsOptimiserK(PackingOptimiser):
    def optimise_box_sizes(self, k=4, alpha=0.7):
        ...
        boxes_dims = np.maximum(np.array(cluster_centers), np.array([self.min_dim['l'], self.min_dim['w'], self.min_dim['h']]))
